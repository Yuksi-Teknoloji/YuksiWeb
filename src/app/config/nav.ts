  ...
  admin: [
    {
      ...
      items: [
        ...
        { label: "Grafikler", path: "admin/charts" },
      ],
    },
    {
      ...
      items: [
        {
          ...
          path: "admin/pricing/restaurant-packages",
        },
        {
          label: "Kurye Fiyatlandırma",
          path: "admin/pricing/courier-packages",
        },
      ],
    },
    {
      ...
      items: [
        { label: "Lojistik Takip", path: "admin/shipments/shipping-list" },
        {
          ...
          path: "admin/shipments/restaurant-shipping-list",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          path: "admin/restaurants/restaurant-list",
        },
        {
          label: "Restoran Oluştur",
          path: "admin/restaurants/create-restaurant",
        },
      ],
    },
    {
    ...
    {
      title: "Kullanıcılar",
      items: [{ label: "Kullanıcı Listesi", path: "admin/user-list" }],
    },
    {
      title: "İçerikler",
      items: [
