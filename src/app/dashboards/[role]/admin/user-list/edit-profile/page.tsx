        ...
        <section className="rounded-2xl border border-neutral-200/70 bg-white p-6 shadow-sm soft-card">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                rows={6}
                className="w-full resize-y rounded-xl border border-neutral-300 bg-white px-3 py-2 outline-none ring-2 ring-transparent transition focus:border-neutral-300 focus:ring-sky-200"
              />
            </div>
          </div>
        </section>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 outline-none ring-2 ring-transparent transition focus:border-neutral-300 focus:ring-sky-200" />
              </div>
              <div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input placeholder="Vergi Dairesi" className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 outline-none ring-2 ring-transparent transition focus:border-neutral-300 focus:ring-sky-200" />
              </div>
              <div>
                <label className="mb-1 block text-sm font-medium text-neutral-700">Vergi No / Kimlik No</label>
                <input placeholder="Vergi Numarası" className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 outline-none ring-2 ring-transparent transition focus:border-neutral-300 focus:ring-sky-200" />
              </div>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input placeholder="iban no" className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2 outline-none ring-2 ring-transparent transition focus:border-neutral-300 focus:ring-sky-200" />
              </div>
              <div>
